...
"settings.nssm_not_found": "NSSM not found",
"settings.autostart": "Autostart",
"settings.autostart_enabled": "Autostart enabled.\n\nClient will start automatically at system boot (before login).",
"settings.autostart_disabled": "Autostart disabled.",
"settings.autostart_failed": "Failed to configure autostart.\n\nMake sure to run the client as Administrator.",
...
"settings.nssm_not_found": "NSSM não encontrado",
"settings.autostart": "Início Automático",
"settings.autostart_enabled": "Início automático ativado.\n\nO client será iniciado automaticamente na inicialização do sistema (antes do login).",
"settings.autostart_disabled": "Início automático desativado.",
"settings.autostart_failed": "Falha ao configurar início automático.\n\nExecute o client como Administrador e tente novamente.",
