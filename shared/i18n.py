...
"settings.autostart_boot_needs_admin": "Note: to enable boot startup (before login), run the client as Administrator and Apply again.",
...
"settings.autostart_boot_needs_admin": "Nota: para iniciar antes do login (boot), execute o client como Administrador e aplique novamente.",
