...
STRINGS = {
    "en": {
        ...
        "notify.pnp_recovery_failed": "Automatic USB recovery failed for {busid}: {msg}",
    ...
    "pt": {
        ...
        "notify.pnp_recovery_failed": "A recuperação automática do USB falhou para {busid}: {msg}",
