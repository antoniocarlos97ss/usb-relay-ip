...
STRINGS = {
    "en": {
        ...
        "status.badge_connected": "Connected",
        "status.badge_service_down": "Service Down",
        "status.badge_online": "Online",
        "status.badge_starting": "Starting",
        "status.badge_stopped": "Stopped",
        "status.badge_offline": "Offline",
    ...
    "pt": {
        ...
        "status.badge_connected": "Conectado",
        "status.badge_service_down": "Serviço indisponível",
        "status.badge_online": "Online",
        "status.badge_starting": "Iniciando",
        "status.badge_stopped": "Parado",
        "status.badge_offline": "Offline",
